define(["exports", "events", "direction", "guide"], function (exports, _events, _direction, _guide) {
  ...
  var Entity = (function () {
    function Entity(location, host) {
      ...
      this.turbo_time = 0;
      this.turbo_left = 1;
      this.movement_counter = 0; // when 0, can move
    ...
    _createClass(Entity, [{
      ...
      value: function do_move() {
        this.movement_counter = Math.max(0, this.movement_counter - 1);
        ...
        if (this.facing !== null) {
          var new_location = [this.location[0] + (0, _direction.dx)(this.facing), this.location[1] + (0, _direction.dy)(this.facing)];

          if (this.host.maze.get2(new_location)) {
            this.location = new_location;
            this.movement_counter = this.speed;
          }
        }
      }
    }, {
